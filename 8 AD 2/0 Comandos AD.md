# Comandos generales AD

Tags: #AD 

* [Herramientas en AD](https://github.com/Spartan-Cybersecurity/CPAD-Tools)
* [Ataques a AD](https://mayfly277.github.io/assets/blog/pentest_ad_dark.svg)

```bash 
Buscar y reemplazar la IP de abajo por tu IP publica o hostname de Ngrok
```
