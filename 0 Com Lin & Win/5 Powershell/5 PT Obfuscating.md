...
```bash 
❯ https://github.com/danielbohannon/Invoke-Obfuscation  # Descargar el script  
❯ https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Reverse%20Shell%20Cheatsheet.md                                                      # Para powershell
```
...
```bash 
# Crearemos una Revershell a la que llamaremos shell.ps1, el cual colocaremos en la sig. ruta:
